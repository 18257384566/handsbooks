        ...
        <div class="container">
            <div class="main" style="margin-top:20px; width:400px; background-color: rgba(255,255,255,0);">
                ...
                <div class="right detail">
                    <p style="display: none">{{$info[0]->id}}</p>
                    <span><b>{{$info[0]->name}}</b></span> &nbsp;
                    <!--                        --><?php //dump($focus) ?>
                    <button class="btn btn-default gz">
                        @if($focus)
                        已关注
                        @else
                        关注
            ...
            <div class="rows">
                ...
                <div class="col-md-9 right b-right">
                    ...
                    <div class="cols">
                        <div class="col-md-2">
                            <a href="/home/detail/{{$item->id}}"><img src="/{{$item->icon}}" alt="" width="120px" height="160"></a>
                        </div>
                        <div class="col-md-10 book-right">
                            <h4 style="float: left"><a href="/home/detail/{{$item->id}}">{{$item->title}}</a></h4> &nbsp;&nbsp;&nbsp; <p style="color:red; padding-top:10px; margin-left:30px; float: left" >￥:{{$item->price}}</p>
                            <br><br>
                            <p>1515人在阅读</p>
