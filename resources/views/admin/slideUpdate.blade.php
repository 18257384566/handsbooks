            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <table class="add_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="mg" name="b_name" value="{{$result->b_name}}"> {{$errors->first('b_name')}}
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>作者：</th>
                        <td>
                            <input type="text" class="mg" name="a_name" value="{{$result->a_name}}"> {{$errors->first('a_name')}}
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>简介：</th>
                        <td>{{$errors->first('desc')}}
                            <textarea class="form-control" rows="3" name="desc">{{$result->desc}}</textarea>
                        </td>
                    </tr>
                    <tr>
